...
import Camera2.src.com.android.camera.CaptureModuleUtil;
import Camera2.src.com.android.camera.debug.Log;
import Camera2.src.com.android.camera.debug.Log.Tag;
import Camera2.src.com.android.camera.exif.ExifInterface;
import Camera2.src.com.android.camera.exif.ExifTag;
import Camera2.src.com.android.camera.exif.Rational;
import Camera2.src.com.android.camera.one.AbstractOneCamera;
import Camera2.src.com.android.camera.one.CameraDirectionProvider;
import Camera2.src.com.android.camera.one.OneCamera;
import Camera2.src.com.android.camera.one.OneCamera.PhotoCaptureParameters.Flash;
import Camera2.src.com.android.camera.one.Settings3A;
import Camera2.src.com.android.camera.one.v2.ImageCaptureManager.ImageCaptureListener;
import Camera2.src.com.android.camera.one.v2.ImageCaptureManager.MetadataChangeListener;
...
import Camera2.src.com.android.camera.processing.imagebackend.TaskImageContainer;
import Camera2.src.com.android.camera.session.CaptureSession;
import com.android.camera.ui.focus.LensRangeCalculator;
import com.android.camera.ui.motion.LinearScale;
import Camera2.src.com.android.camera.util.CameraUtil;
import Camera2.src.com.android.camera.util.ExifUtil;
import Camera2.src.com.android.camera.util.JpegUtilNative;
import Camera2.src.com.android.camera.util.ListenerCombiner;
...
public class OneCameraZslImpl extends AbstractOneCamera {
    ...
    /**
     * @see OneCamera#triggerFocusAndMeterAtPoint(float,
     *      float)
     */
    @Override
