...
import Camera2.src.android.util.CameraPerformanceTracker;
...
import Camera2.src.com.android.camera.AccessibilityUtil;
import Camera2.src.com.android.camera.AnimationManager;
import Camera2.src.com.android.camera.ButtonManager;
import Camera2.src.com.android.camera.CaptureLayoutHelper;
import Camera2.src.com.android.camera.ShutterButton;
import Camera2.src.com.android.camera.TextureViewHelper;
import Camera2.src.com.android.camera.debug.Log;
import Camera2.src.com.android.camera.filmstrip.FilmstripContentPanel;
import Camera2.src.com.android.camera.hardware.HardwareSpec;
import Camera2.src.com.android.camera.module.ModuleController;
import Camera2.src.com.android.camera.settings.Keys;
...
import Camera2.src.com.android.camera.util.AndroidServices;
import Camera2.src.com.android.camera.util.ApiHelper;
import Camera2.src.com.android.camera.util.CameraUtil;
import Camera2.src.com.android.camera.util.Gusterpolator;
import Camera2.src_pd.com.android.camera.util.PhotoSphereHelper;
import Camera2.src.com.android.camera.widget.Cling;
import Camera2.src.com.android.camera.widget.FilmstripLayout;
import Camera2.src.com.android.camera.widget.IndicatorIconController;
import Camera2.src.com.android.camera.widget.ModeOptionsOverlay;
import Camera2.src.com.android.camera.widget.RoundedThumbnailView;
...
public class CameraAppUI implements ModeListView.ModeSwitchListener,
    ...
    public static class BottomBarUISpec {
        ...
        /**
         * A {@link ButtonManager.ButtonCallback}
    ...
    /**
     * Returns a {@link ButtonManager.ButtonCallback} that
