...
package Camera2.src.com.android.camera.data;

import android.net.Uri;
import android.os.AsyncTask;

import Camera2.src.com.android.camera.filmstrip.FilmstripDataAdapter;
import Camera2.src.com.android.camera.util.Callback;
import Camera2.src.com.android.camera.widget.Preloader;

import java.util.List;

/**
 * An interface which extends {@link FilmstripDataAdapter}
